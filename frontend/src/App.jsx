...
function App() {
    ...
    return (
        <div className="min-h-screen flex flex-col">
            ...
            <main className="max-w-[900px] mt-24 mx-auto px-6 w-full grow mb-20">
                <Routes>
                    <Route 
                        path="/" 
                        element={
            ...
            <footer className="max-w-[900px] mx-auto w-full px-6 pt-12 border-t border-border-muted flex justify-between items-center text-xs font-semibold text-text-light pb-8">
